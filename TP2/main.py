...
def creationGrapheOriente(id, path):
...
# Graph2 = creationGraphe(2, 'fileGraph2.csv')
Graph3 = creationGrapheOriente(3, 'fileGraph2.csv')
# Graph1.printGraph()
# print(Graph2.dijkstra(1, 10))
print(Graph3.dijkstra(1, 10))
